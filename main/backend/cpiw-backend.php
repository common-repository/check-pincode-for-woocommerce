                            ...
                            <div class="postbox">
                                ...
                                <div class="inside">
                                    <table>
                                        ...
                                        <tr>
                                            <th>
                                              <?php echo __( 'Cash on delivery text color', 'check-pincode-in-woocommerce' ); ?>
                                            </th>
                                            <td>
                                                <?php 
                                ...
                                <div class="inside">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                              <input type="text" disabled name="cpiw_comman[cpiw_cod_text]" class="regular-text" value="Cash On Delivery Available"><br>
                                              <label class="cpiw_pro_version_link"><a href="https://www.plugin999.com/plugin/check-pincode-for-woocommerce/" target="_blank">Only Available In Pro Version</a></label>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                              <input type="text" disabled name="cpiw_comman[cpiw_cod_not_availbal_text]" class="regular-text" value="Cash On Delivery Not Available"><br>
                                              <label class="cpiw_pro_version_link"><a href="https://www.plugin999.com/plugin/check-pincode-for-woocommerce/" target="_blank">Only Available In Pro Version</a></label>
                                            </td>
                                        </tr>
                                        <tr>
